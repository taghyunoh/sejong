...
public class NCP_SMSUtil {
    ...
    public void sendSMS(String phone) {
    	try {
			...
			String requestUrlType = "/messages";                      		// 요청 URL						// service ID : https://console.ncloud.com/sens/project > Simple & ... > Project > 서비스 ID
		    ...
		    bodyJson.put("from","0429328820");					// Mandatory, 발신번호, 사전 등록된 발신번호만 사용 가능		
		    String authCode = generateAuthCode();
		    bodyJson.put("content","[allCare] \n인증번호 : " + authCode);	// Mandatory(필수), 기본 메시지 내용, SMS: 최대 80byte, LMS, MMS: 최대 2000byte

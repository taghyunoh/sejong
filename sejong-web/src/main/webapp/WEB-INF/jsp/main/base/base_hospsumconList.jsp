	...
	function fnSearch(gbn) {
		...
		if (gbn == 'M') {
			$("#dataArea1").empty();
				$.ajax({
						type : "post",
						url : CommonUtil.getContextPath()+ '/base/ctl_hospsumList.do',
						...
						success : function(data) {
							...
							if (data.resultCnt > 0) {
								...
								for (var i = 0; i < data.resultCnt; i++) {
									...
									dataTxt += "<td>"+ data.resultLst[i].name2+ "</td>";
									dataTxt += "<td>"+ data.resultLst[i].start_dt2+ "</td>";
									dataTxt += "<td>"+ data.resultLst[i].end_dt2+ "</td>";
									dataTxt += "<td>"+ data.resultLst[i].accept_dt2+ "</td>";
									dataTxt += "<td>"+ data.resultLst[i].close_dt2+ "</td>";
									dataTxt += "<td>"+ data.resultLst[i].name1+ "</td>";
				...
				if (iud2 == "I") {
					...
					$.ajax({
						...
						success : function(data) {
							...
							$("#accept_dt2").val(data.result.accept_dt2);
							...
							<div class="table-responsive">
								<table id="infoTable" class="table table-bordered">
									<colgroup>
										...
										<col style="width: 100px"> <!--  auto; min-width: 120px"> -->
